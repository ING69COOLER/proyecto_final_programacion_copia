...
class ExcelExporter:
    ...
    def add_chart(self, sheet, evento_nombre):
        ...
        # Filtrar datos para el evento específico
        ...
        # Asegurarnos de que el rango de datos incluya ambas filas de ingresos (VIP y regular)
    ...
    def adjust_column_width(sheet):
        ...
        for column_cells in sheet.columns:
            max_length = 0
            column_letter = None  # Initialize column_letter as None
            
            for cell in column_cells:
                # Ensure column_letter is set by checking for non-MergedCell cells
                if column_letter is None and not isinstance(cell, MergedCell):
                    column_letter = cell.column_letter

                # Ignore merged cells and only consider actual cells with values
