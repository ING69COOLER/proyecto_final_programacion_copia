...
public class RegistroController implements Utils {
    ...
    @FXML
    private PasswordField txt_clave_empresarial;

    @FXML
    private PasswordField txt_contraseña_1;

    @FXML
    private PasswordField txt_contraseña_2;
    ...
    private void registar() throws IOException {
        ...
        if (contraseña1.equals(contraseña2) && clave.equals(getClave_empresarial())) {
            ...
            if (usuarioExiste(usuario)) {
                ...
                mostrarAlerta("Usuario ya existe", "El usuario ya existe. Intenta con otro nombre de usuario.");
            } else {
                // Agregar el usuario a la base de datos
                crearUsuario(usuario, contraseña1);// Modificar para enviar objeto completo :)

                mostrarAlertaExito("Usuario registrado", "El usuario ha sido registrado con exito.");
            ...
            mostrarAlerta("Error al registrar", "Las contraseñas no coinciden o la clave empresarial es incorrecta.");
        }
    }
